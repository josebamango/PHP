...
<body>
    ...
    {
        for ($i = 0; $i < $numero; $i++) {
            $alea[$i] = rand(0, $numero * 9 ); /*esto es de  donde a donde quieres 
            que vaya. En este caso aleatorios del 0 la 90*/ 
        }
        return $alea;
    }
    ...
    // creo la variable array1 y la inicio cargando un array aleatorio de 11 vainas
    $array1 = cargar(11);
    $array2 = cargar(11);
    //escribir($array1);
    //escribir($array2);
